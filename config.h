...
static const char *rngwall[]  = { "wall.sh", NULL };
static const char *rmpc[]     = { "music_control.sh", "togglepause", NULL };
static const char *rmpc_prev[]= { "music_control.sh", "prev", NULL };
static const char *rmpc_next[]= { "music_control.sh", "next", NULL };
